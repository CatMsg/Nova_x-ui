// Package main is the entry point for the Nova_x-ui web panel application.
...
import (
	...
	"github.com/CatMsg/Nova_x-ui/v3/sub"
	"github.com/CatMsg/Nova_x-ui/v3/util/crypto"
	"github.com/CatMsg/Nova_x-ui/v3/util/sys"
	"github.com/CatMsg/Nova_x-ui/v3/web"
	"github.com/CatMsg/Nova_x-ui/v3/web/global"
...
// runWebServer initializes and starts the web server for the Nova_x-ui panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the Nova_x-ui panel.
func migrateDb() {
...
// main is the entry point of the Nova_x-ui application.
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate from other/old panel")
