...
import (
	...
	"github.com/CatMsg/Nova_x-ui/v3/util/random"
...
// (socks, http, mixed, wireguard, dokodemo-door, tunnel, tun). The returned string may
...
// accidentally produce a useless host like "https://:2026".
...
// applyKcpShareParams reconstructs previous KCP share-link fields from either
