...
// trigger a full page reload (matches previous ergonomics), so we don't
...
// the Nova_x-ui panel keeps working after a user upgrades. Falls back
...
export const i18n = createI18n({
  legacy: false,
  // `composition` mode so `useI18n()` works in
  // <script setup> blocks.
