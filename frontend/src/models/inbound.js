...
export class HysteriaStreamSettings extends XrayCommonClass {
    ...
    static fromJson(json = {}) {
        return new HysteriaStreamSettings(
            ...
            normalizeHy2Ports(json.server_ports ?? json.serverPorts),
            normalizeHy2HopInterval(json.hop_interval ?? json.hopInterval),
        );
    }
    ...
    toJson() {
        ...
        if (this.version === 2 && Array.isArray(this.serverPorts) && this.serverPorts.length > 0) {
            result.server_ports = normalizeHy2Ports(this.serverPorts);
        }
        const hopInterval = this.version === 2 ? normalizeHy2HopInterval(this.hopInterval) : '';
        if (hopInterval) {
...
function normalizeHy2Ports(value) {
    ...
    if (Array.isArray(value)) {
        value.forEach(pushPort);
    } else if (typeof value === 'string') {
        value.split(',').forEach(pushPort);
...
function normalizeHy2HopInterval(value) {
...
export class Inbound extends XrayCommonClass {
    ...
    canEnableTls() {
        ...
        if ([Protocols.WIREGUARD, Protocols.TUN].includes(this.protocol)) return false;
    ...
    canEnableStream() {
        return ![Protocols.WIREGUARD, Protocols.TUN].includes(this.protocol);
    }
...
Inbound.Settings = class extends XrayCommonClass {
    ...
    static getSettings(protocol) {
        switch (protocol) {
            ...
            case Protocols.DOKODEMO_DOOR: return new Inbound.TunnelSettings(protocol);
    ...
    static fromJson(protocol, json) {
        switch (protocol) {
            ...
            case Protocols.TUNNEL: return Inbound.TunnelSettings.fromJson(json, Protocols.TUNNEL);
            case Protocols.DOKODEMO_DOOR: return Inbound.TunnelSettings.fromJson(json, Protocols.DOKODEMO_DOOR);
            case Protocols.MIXED: return Inbound.MixedSettings.fromJson(json, Protocols.MIXED);
            case Protocols.HTTP: return Inbound.HttpSettings.fromJson(json, Protocols.HTTP);
...
Inbound.TunnelSettings = class extends Inbound.Settings {
    ...
    static fromJson(json = {}, protocol = Protocols.TUNNEL) {
...
Inbound.HttpSettings = class extends Inbound.Settings {
    ...
    static fromJson(json = {}, protocol = Protocols.HTTP) {
