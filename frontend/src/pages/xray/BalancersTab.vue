...
// templateSettings.routing.balancers. The Nova_x-ui panel kept the wire
...
// Observatory defaults — values that the Nova_x-ui panel seeded when a
...
// the Nova_x-ui panel used (https://xtls.github.io/config/burstobservatory.html).
...
function onConfirm(form) {
  ...
  if (editingIndex.value == null) {
    ...
    // Preserve the previous behavior: when a balancer's tag is renamed,
...
// The Nova_x-ui panel surfaced both top-level observatory blocks here as a
