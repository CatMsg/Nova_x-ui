...
// roll-ups the Nova_x-ui panel surfaces in the popovers.
//
...
export function useInbounds() {
  ...
  // comments} for a single inbound. Mirrors getClientCounts in the previous
  ...
  async function refresh() {
    ...
    try {
      ...
      // Match previous: keep the spinning-icon state visible briefly so
  ...
  // here so the linter doesn't drop it; the previous search uses it.
  void ObjectUtil;
