// Package web provides the main web server implementation for the Nova_x-ui panel,
...
import (
	...
	"github.com/CatMsg/Nova_x-ui/v3/web/controller"
	"github.com/CatMsg/Nova_x-ui/v3/web/job"
	"github.com/CatMsg/Nova_x-ui/v3/web/locale"
	"github.com/CatMsg/Nova_x-ui/v3/web/middleware"
	"github.com/CatMsg/Nova_x-ui/v3/web/network"
	"github.com/CatMsg/Nova_x-ui/v3/web/runtime"
	"github.com/CatMsg/Nova_x-ui/v3/web/service"
	"github.com/CatMsg/Nova_x-ui/v3/web/websocket"
...
// HTML route is served straight out of this FS — the previous Go
...
// Server represents the main web server for the Nova_x-ui panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("Nova_x-ui", store))
	...
	// Apply the redirect middleware for legacy panel route casing.
