// Package entity defines data structures and entities used by the web layer of the Nova_x-ui panel.
package entity
...
// AllSetting contains all configuration settings for the Nova_x-ui panel including web server, Telegram bot, and subscription settings.
