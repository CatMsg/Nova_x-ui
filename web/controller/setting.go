...
func (a *SettingController) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/getHy2ForwardBackend", a.getHy2ForwardBackend)
...
// getHy2ForwardBackend returns the current backend detected for HY2 port forwarding.
func (a *SettingController) getHy2ForwardBackend(c *gin.Context) {
	backend, err := a.settingService.GetHy2ForwardBackend()
	if err != nil {
		jsonMsg(c, I18nWeb(c, "pages.settings.toasts.getSettings"), err)
		return
	}
	jsonObj(c, backend, nil)
}
