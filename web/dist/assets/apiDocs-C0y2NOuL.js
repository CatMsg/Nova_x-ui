import{S as e,a as t,c as n,n as r,t as i,v as a}from"./_plugin-vue_export-helper-iV4evElo.js";import{B as o,E as s,F as c,G as l,Ht as u,K as d,Kt as f,R as p,U as m,V as h,W as g,X as _,Y as v,at as y,c as b,d as ee,dt as x,f as S,ft as C,it as w,j as T,k as E,m as D,nt as O,o as k,q as A,r as j,st as M,t as N,v as P,xt as F,yt as I}from"./vendor-antd-C1Goo1fJ.js";import{P as te,T as L,z as R}from"./vendor-icons-C8nTYsZx.js";import{t as z}from"./axios-init-DIYdqgAU.js";import{n as ne}from"./vendor-i18n-B9QgBnYD.js";import{t as re}from"./AppSidebar-CmCV_lGb.js";function B(e){if(!e)return``;let t=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`),n=``,r=0;for(;r<e.length;){let i=e.indexOf(`<code>`,r);if(i===-1){n+=t(e.slice(r));break}n+=t(e.slice(r,i));let a=e.indexOf(`</code>`,i+6);if(a===-1){n+=t(e.slice(i));break}n+=`<code>`+t(e.slice(i+6,a))+`</code>`,r=a+7}return n}var V=[{id:`auth`,title:`Authentication`,description:`Two authentication modes are supported. UI sessions use a cookie set by the login endpoint. Programmatic clients (bots, scripts, remote panels) authenticate with a Bearer token taken from Settings → Security → API Token. Both work for every endpoint under /panel/api/*.`,endpoints:[{method:`POST`,path:`/login`,summary:`Authenticate with username + password and receive a session cookie. Required before any cookie-based API call.`,params:[{name:`username`,in:`body`,type:`string`,desc:`Panel admin username.`},{name:`password`,in:`body`,type:`string`,desc:`Panel admin password.`},{name:`twoFactorCode`,in:`body`,type:`string`,desc:`OTP code when 2FA is enabled. Omit otherwise.`}],body:`{
  ...
  "type": "invalidate",
  "resource": "inbounds"
}`}]}],H={GET:`blue`,POST:`green`,PUT:`orange`,PATCH:`orange`,DELETE:`red`,WS:`purple`},U={class:`code-block-wrapper`},W=[`title`],G=[`innerHTML`],K=i({__name:`CodeBlock`,props:{code:{type:String,default:``},lang:{type:String,default:`json`}},setup(e){let t=e,n=I(!1);function r(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function i(e){return r(e).replace(/("(?:[^"\\]|\\.)*")\s*(:)|("(?:[^"\\]|\\.)*")|(-?\d+\.?\d*(?:[eE][+-]?\d+)?)\b|(true|false)|(null)|([{}\[\]])/g,(e,t,n,r,i,a,o)=>n?`<span class="json-key">${t}</span>${n}`:r?`<span class="json-string">${r}</span>`:i?`<span class="json-number">${i}</span>`:a?`<span class="json-boolean">${a}</span>`:o?`<span class="json-null">${o}</span>`:e)}let a=m(()=>t.lang===`json`?i(t.code):r(t.code));async function o(){try{await navigator.clipboard.writeText(t.code),n.value=!0,D.success(`Copied`),setTimeout(()=>{n.value=!1},2e3)}catch{D.error(`Copy failed`)}}return(t,r)=>(w(),A(`div`,U,[g(`button`,{class:u([`copy-btn`,{copied:n.value}]),onClick:o,title:n.value?`Copied`:`Copy`},[n.value?(w(),l(F(E),{key:0})):(w(),l(F(k),{key:1}))],10,W),g(`pre`,{class:u([`code-block`,`lang-${e.lang}`])},[g(`code`,{innerHTML:a.value},null,8,G)],2)]))}},[[`__scopeId`,`data-v-9f7e0177`]]),q={class:`endpoint-row`},J={class:`endpoint-header`},Y={class:`endpoint-path`},X=[`innerHTML`],Z={key:1,class:`endpoint-block`},Q={key:2,class:`endpoint-block`},ie={key:3,class:`endpoint-block`},ae={key:4,class:`endpoint-block`},oe=i({__name:`EndpointRow`,props:{endpoint:{type:Object,required:!0}},setup(e){let t=e,n=m(()=>H[t.endpoint.method]||`default`),r=m(()=>Array.isArray(t.endpoint.params)&&t.endpoint.params.length>0),i=[{title:`Name`,dataIndex:`name`,key:`name`,width:180},{title:`In`,dataIndex:`in`,key:`in`,width:100},{title:`Type`,dataIndex:`type`,key:`type`,width:120},{title:`Description`,dataIndex:`desc`,key:`desc`}];return(t,a)=>{let o=M(`a-tag`),s=M(`a-table`);return w(),A(`div`,q,[g(`div`,J,[_(o,{color:n.value,class:`method-tag`},{default:x(()=>[v(f(e.endpoint.method),1)]),_:1},8,[`color`]),g(`code`,Y,f(e.endpoint.path),1)]),e.endpoint.summary?(w(),A(`p`,{key:0,class:`endpoint-summary`,innerHTML:F(B)(e.endpoint.summary)},null,8,X)):d(``,!0),r.value?(w(),A(`div`,Z,[a[0]||(a[0]=g(`div`,{class:`block-label`},`Parameters`,-1)),_(s,{columns:i,"data-source":e.endpoint.params,pagination:!1,size:`small`,"row-key":`name`},null,8,[`data-source`])])):d(``,!0),e.endpoint.body?(w(),A(`div`,Q,[a[1]||(a[1]=g(`div`,{class:`block-label`},`Request body`,-1)),_(K,{code:e.endpoint.body,lang:`json`},null,8,[`code`])])):d(``,!0),e.endpoint.response?(w(),A(`div`,ie,[a[2]||(a[2]=g(`div`,{class:`block-label`},`Response`,-1)),_(K,{code:e.endpoint.response,lang:`json`},null,8,[`code`])])):d(``,!0),e.endpoint.errorResponse?(w(),A(`div`,ae,[a[3]||(a[3]=g(`div`,{class:`block-label error-label`},`Error response`,-1)),_(K,{code:e.endpoint.errorResponse,lang:`json`},null,8,[`code`])])):d(``,!0)])}}},[[`__scopeId`,`data-v-7e5e55d0`]]),se=[`id`],ce={class:`section-header-left`},le={class:`section-title`},ue={class:`endpoint-count`},de=[`innerHTML`],fe={key:1,class:`sub-header-block`},pe=[`innerHTML`],me={class:`endpoints`},he=i({__name:`EndpointSection`,props:{section:{type:Object,required:!0},collapsed:{type:Boolean,default:!1}},emits:[`toggle`],setup(e,{emit:t}){let n=e,r=t,i=m(()=>n.section.endpoints.length===1?`1 endpoint`:`${n.section.endpoints.length} endpoints`);return(t,n)=>{let a=M(`a-table`);return w(),A(`section`,{id:e.section.id,class:`api-section`},[g(`div`,{class:`section-header`,onClick:n[0]||(n[0]=e=>r(`toggle`))},[g(`div`,ce,[e.collapsed?(w(),l(F(P),{key:1,class:`collapse-icon`})):(w(),l(F(T),{key:0,class:`collapse-icon`})),g(`h2`,le,f(e.section.title),1)]),g(`span`,ue,f(i.value),1)]),e.section.description&&!e.collapsed?(w(),A(`p`,{key:0,class:`section-description`,innerHTML:F(B)(e.section.description)},null,8,de)):d(``,!0),e.section.subHeader&&!e.collapsed?(w(),A(`div`,fe,[n[1]||(n[1]=g(`div`,{class:`block-label`},`Response headers`,-1)),_(a,{columns:[{title:`Header`,dataIndex:`name`,key:`name`,width:240},{title:`Description`,dataIndex:`desc`,key:`desc`}],"data-source":e.section.subHeader,pagination:!1,size:`small`,"row-key":`name`},{bodyCell:x(({column:e,text:t})=>[e.dataIndex===`desc`?(w(),A(`span`,{key:0,innerHTML:F(B)(t)},null,8,pe)):(w(),A(h,{key:1},[v(f(t),1)],64))]),_:1},8,[`data-source`])])):d(``,!0),C(g(`div`,me,[(w(!0),A(h,null,y(e.section.endpoints,(e,t)=>(w(),l(oe,{key:t,endpoint:e},null,8,[`endpoint`]))),128))],512),[[p,!e.collapsed]])],8,se)}}},[[`__scopeId`,`data-v-bc92dd53`]]),ge={class:`docs-wrapper`},_e={class:`token-card-head`},ve={class:`token-card-title`},ye={class:`token-value`},be={class:`toolbar`},xe={key:0,class:`match-count`},Se={class:`toc-nav`},Ce=[`href`,`onClick`],we=`curl -X GET \\
  -H "Authorization: Bearer YOUR_API_TOKEN" \\
  -H "Accept: application/json" \\
  https://your-panel.example.com/panel/api/inbounds/list`,Te=i({__name:`ApiDocsPage`,setup(r){let{t:i}=ne(),c=window.X_UI_BASE_PATH||``,p=window.location.pathname,C=I(``),T=I(!1),E=I(!1),N=I(!1),P=I(``),z=I(new Set),B=m(()=>{let e=P.value.toLowerCase().trim();return e?V.map(t=>{let n=t.endpoints.filter(t=>t.path.toLowerCase().includes(e)||t.summary?.toLowerCase().includes(e)||t.method.toLowerCase().includes(e));return{...t,endpoints:n}}).filter(e=>e.endpoints.length>0):V}),H=m(()=>V.reduce((e,t)=>e+t.endpoints.length,0)),U=m(()=>B.value.reduce((e,t)=>e+t.endpoints.length,0));function W(e){return z.value.has(e)}function G(e){let t=new Set(z.value);t.has(e)?t.delete(e):t.add(e),z.value=t}function q(){z.value=new Set}function J(){z.value=new Set(V.map(e=>e.id))}async function Y(){T.value=!0;try{let e=await n.get(`/panel/setting/getApiToken`);e?.success&&(C.value=e.obj||``)}finally{T.value=!1}}function X(){b.confirm({title:i(`pages.nodes.regenerateConfirm`),okText:i(`confirm`),cancelText:i(`cancel`),okType:`danger`,onOk:async()=>{E.value=!0;try{let e=await n.post(`/panel/setting/regenerateApiToken`);e?.success&&(C.value=e.obj||``,D.success(i(`success`)))}finally{E.value=!1}}})}async function Z(){C.value&&await t.copyText(C.value)&&D.success(i(`success`))}function Q(e){let t=document.getElementById(e);t&&t.scrollIntoView({behavior:`smooth`,block:`start`})}return O(()=>{Y()}),(t,n)=>{let r=M(`a-button`),i=M(`a-space`),m=M(`a-spin`),b=M(`a-card`),D=M(`a-input-search`),O=M(`a-layout-content`),I=M(`a-layout`),z=M(`a-config-provider`);return w(),l(z,{theme:F(a)},{default:x(()=>[_(I,{class:u([`api-docs-page`,{"is-dark":F(e).isDark,"is-ultra":F(e).isUltra}])},{default:x(()=>[_(re,{"base-path":F(c),"request-uri":F(p)},null,8,[`base-path`,`request-uri`]),_(I,{class:`content-shell`},{default:x(()=>[_(O,{class:`content-area`},{default:x(()=>[g(`div`,ge,[n[9]||(n[9]=g(`header`,{class:`docs-header`},[g(`h1`,{class:`docs-title`},`API Documentation`),g(`p`,{class:`docs-lead`},[v(` The Nova_x-ui panel exposes a REST API under `),g(`code`,null,`/panel/api/`),v(`. Authenticate with the panel session cookie, or with the `),g(`code`,null,`Authorization: Bearer <token>`),v(` header below. Every endpoint returns a uniform `),g(`code`,null,`{ success, msg, obj }`),v(` envelope unless otherwise noted. `)])],-1)),_(b,{class:`token-card`,size:`small`},{default:x(()=>[g(`div`,_e,[g(`div`,ve,[_(F(L)),n[2]||(n[2]=g(`span`,null,`API Token`,-1))]),_(i,{size:`small`,wrap:``},{default:x(()=>[_(r,{size:`small`,onClick:n[0]||(n[0]=e=>N.value=!N.value)},{icon:x(()=>[N.value?(w(),l(F(ee),{key:0})):(w(),l(F(S),{key:1}))]),default:x(()=>[v(` `+f(N.value?`Hide`:`Show`),1)]),_:1}),_(r,{size:`small`,disabled:!C.value,onClick:Z},{icon:x(()=>[_(F(k))]),default:x(()=>[n[3]||(n[3]=v(` Copy `,-1))]),_:1},8,[`disabled`]),_(r,{size:`small`,danger:``,loading:E.value,onClick:X},{icon:x(()=>[_(F(j))]),default:x(()=>[n[4]||(n[4]=v(` Regenerate `,-1))]),_:1},8,[`loading`])]),_:1})]),_(m,{spinning:T.value,size:`small`},{default:x(()=>[g(`pre`,ye,f(N.value?C.value||`—`:C.value?`••••••••••••••••••••••••••••`:`—`),1)]),_:1},8,[`spinning`]),n[5]||(n[5]=g(`p`,{class:`token-hint`},[v(` Send it on every request as `),g(`code`,null,`Authorization: Bearer <token>`),v(`. Token-authenticated callers skip CSRF and don't need a session cookie. Regenerating rotates the secret immediately — running bots will need the new value. `)],-1))]),_:1}),_(b,{class:`curl-card`,size:`small`,title:`Quick example`},{default:x(()=>[_(K,{code:we,lang:`text`})]),_:1}),g(`div`,be,[_(D,{value:P.value,"onUpdate:value":n[1]||(n[1]=e=>P.value=e),placeholder:`Search endpoints by path, method, or description…`,"allow-clear":``,class:`search-bar`},{prefix:x(()=>[_(F(s))]),_:1},8,[`value`]),P.value?(w(),A(`span`,xe,f(U.value)+` / `+f(H.value)+` endpoints `,1)):d(``,!0),_(i,{size:`small`},{default:x(()=>[_(r,{size:`small`,onClick:q},{icon:x(()=>[_(F(te))]),default:x(()=>[n[6]||(n[6]=v(` Expand all `,-1))]),_:1}),_(r,{size:`small`,onClick:J},{icon:x(()=>[_(F(R))]),default:x(()=>[n[7]||(n[7]=v(` Collapse all `,-1))]),_:1})]),_:1})]),g(`nav`,Se,[n[8]||(n[8]=g(`span`,{class:`toc-label`},`On this page:`,-1)),(w(!0),A(h,null,y(B.value,e=>(w(),A(`a`,{key:e.id,class:`toc-link`,href:`#${e.id}`,onClick:o(t=>Q(e.id),[`prevent`])},f(e.title)+` (`+f(e.endpoints.length)+`) `,9,Ce))),128))]),(w(!0),A(h,null,y(B.value,e=>(w(),l(he,{key:e.id,section:e,collapsed:W(e.id),onToggle:t=>G(e.id)},null,8,[`section`,`collapsed`,`onToggle`]))),128))])]),_:1})]),_:1})]),_:1},8,[`class`])]),_:1},8,[`theme`])}}},[[`__scopeId`,`data-v-247fd61a`]]);z();var $=document.getElementById(`message`);$&&D.config({getContainer:()=>$}),c(Te).use(N).use(r).mount(`#app`);
//# sourceMappingURL=apiDocs-C0y2NOuL.js.map