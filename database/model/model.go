// Package model defines the database models and data structures used by the Nova_x-ui panel.
package model

import (
	"fmt"

	"github.com/CatMsg/Nova_x-ui/v3/util/json_util"
...
// User represents a user account in the Nova_x-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the Nova_x-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote Nova_x-ui panel registered with the central panel.
...
type Client struct {
	...
	User       string         `json:"user,omitempty"`               // Username for HTTP/SOCKS-style inbounds
	Pass       string         `json:"pass,omitempty"`               // Password for HTTP/SOCKS-style inbounds
