// Package logger provides logging functionality for the Nova_x-ui panel with
...
const (
	...
	logFileName      = "Nova_x-ui.log"       // Log file name
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("Nova_x-ui")
	...
	if consoleBackend := initDefaultBackend(); consoleBackend != nil {
		...
		leveledBackend.SetLevel(level, "Nova_x-ui")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "Nova_x-ui")
		backends = append(backends, leveledBackend)
	}
